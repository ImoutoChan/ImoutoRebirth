...
namespace ImoutoRebirth.LilinService.WebApi.Client
{
    ...
    public partial class TagsClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual System.Collections.Generic.IReadOnlyCollection<Tag> GetPopularCharactersTags(int limit)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetPopularCharactersTagsAsync(limit, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyCollection<Tag>> GetPopularCharactersTagsAsync(int limit, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/tags/popular-characters?");
            urlBuilder_.Append(System.Uri.EscapeDataString("limit") + "=").Append(System.Uri.EscapeDataString(ConvertToString(limit, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
