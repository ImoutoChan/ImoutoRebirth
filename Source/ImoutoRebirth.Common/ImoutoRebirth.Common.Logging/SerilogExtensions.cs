...
public static class SerilogExtensions
{
    ...
    {
        public LoggerConfiguration WithoutDefaultLoggers()
            => configuration.MinimumLevel.Verbose()
                .MinimumLevel.Override("Microsoft", LogEventLevel.Warning)
                .MinimumLevel.Override("System", LogEventLevel.Warning);

        public LoggerConfiguration WithConsole()
            => configuration.WriteTo.Console(
                outputTemplate: ConsoleTemplate,
                restrictedToMinimumLevel: LogEventLevel.Verbose);

        public LoggerConfiguration WithAllRollingFile(string pathFormat = "logs/all.log")
        ...
        public LoggerConfiguration WithInformationRollingFile(string pathFormat = "logs/information.log")
            => configuration.WriteTo.File(
                pathFormat,
                outputTemplate: FileTemplate,
                rollingInterval: RollingInterval.Day,
        ...
        public LoggerConfiguration WithOpenSearch(
