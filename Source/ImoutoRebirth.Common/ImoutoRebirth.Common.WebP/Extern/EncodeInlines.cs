...
public partial class NativeMethods
{
    ...
    {
        return NativeMethods.WebPConfigInitInternal(ref config,
    ...
    {
        return NativeMethods.WebPConfigInitInternal(ref config, preset, quality,
    ...
    {
        return NativeMethods.WebPPictureInitInternal(ref picture,
            WEBP_ENCODER_ABI_VERSION);
    }
}
