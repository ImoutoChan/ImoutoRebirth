...
namespace ImoutoRebirth.Room.WebApi.Client
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task UpdateSourceTagsAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "collection-files/update-source-tags"
                    urlBuilder_.Append("collection-files/update-source-tags");
        ...
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task UpdateFileMetadataAsync()
        {
            return UpdateFileMetadataAsync(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task UpdateFileMetadataAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "collection-files/update-file-metadata"
                    urlBuilder_.Append("collection-files/update-file-metadata");
        ...
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<string> RenameCollectionFileAsync(System.Guid id, string newFileName)
        {
            return RenameCollectionFileAsync(id, newFileName, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> RenameCollectionFileAsync(System.Guid id, string newFileName, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            if (newFileName == null)
                throw new System.ArgumentNullException("newFileName");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "collection-files/{id}/rename"
                    urlBuilder_.Append("collection-files/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/rename");
                    urlBuilder_.Append('?');
                    urlBuilder_.Append(System.Uri.EscapeDataString("newFileName")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(newFileName, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Length--;
        ...
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<CanRenameCollectionFileToResult> CanRenameCollectionFileAsync(System.Guid id, string newFileName)
        {
            return CanRenameCollectionFileAsync(id, newFileName, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<CanRenameCollectionFileToResult> CanRenameCollectionFileAsync(System.Guid id, string newFileName, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "collection-files/{id}/renaming-availability"
                    urlBuilder_.Append("collection-files/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/renaming-availability");
                    urlBuilder_.Append('?');
                    urlBuilder_.Append(System.Uri.EscapeDataString("newFileName")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(newFileName, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Length--;
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CanRenameCollectionFileToResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new WebApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class IntegrityReportsClient 
    {
        private System.Net.Http.HttpClient _httpClient;
        private static System.Lazy<System.Text.Json.JsonSerializerOptions> _settings = new System.Lazy<System.Text.Json.JsonSerializerOptions>(CreateSerializerSettings, true);
        private System.Text.Json.JsonSerializerOptions _instanceSettings;
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public IntegrityReportsClient(System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            _httpClient = httpClient;
            Initialize();
        ...
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Guid> BuildIntegrityReportAsync(CreateIntegrityReportJobCommand body)
        {
            return BuildIntegrityReportAsync(body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Guid> BuildIntegrityReportAsync(CreateIntegrityReportJobCommand body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "integrity-reports"
                    urlBuilder_.Append("integrity-reports");
        ...
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyCollection<IntegrityReportResult>> GetIntegrityReportsAsync(int? count, int? skip)
        {
            return GetIntegrityReportsAsync(count, skip, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyCollection<IntegrityReportResult>> GetIntegrityReportsAsync(int? count, int? skip, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.IReadOnlyCollection<IntegrityReportResult>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new WebApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task PauseIntegrityReportAsync(System.Guid reportId)
        {
            return PauseIntegrityReportAsync(reportId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task PauseIntegrityReportAsync(System.Guid reportId, System.Threading.CancellationToken cancellationToken)
        {
            if (reportId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "integrity-reports/{reportId}/pause"
                    urlBuilder_.Append("integrity-reports/");
        ...
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task ResumeIntegrityReportAsync(System.Guid reportId)
        {
            return ResumeIntegrityReportAsync(reportId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="WebApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task ResumeIntegrityReportAsync(System.Guid reportId, System.Threading.CancellationToken cancellationToken)
        {
            if (reportId == null)
                throw new System.ArgumentNullException("reportId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "integrity-reports/{reportId}/resume"
                    urlBuilder_.Append("integrity-reports/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(reportId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class AddSourceFolderCommand
    {
        ...
        public AddSourceFolderCommand(System.Guid @collectionId, bool @isWebhookUploadEnabled, string @path, bool @shouldAddTagFromFilename, bool @shouldCheckFormat, bool @shouldCheckHashFromName, bool @shouldCreateTagsFromSubfolders, System.Collections.Generic.IReadOnlyCollection<string> @supportedExtensions, string? @webhookUploadUrl)
        {
            ...
            this.IsWebhookUploadEnabled = @isWebhookUploadEnabled;
            this.WebhookUploadUrl = @webhookUploadUrl;
        }
        ...
        [System.Text.Json.Serialization.JsonPropertyName("isWebhookUploadEnabled")]
        public bool IsWebhookUploadEnabled { get; }

        [System.Text.Json.Serialization.JsonPropertyName("webhookUploadUrl")]
        public string? WebhookUploadUrl { get; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CanRenameCollectionFileToResult
    {
        [System.Text.Json.Serialization.JsonConstructor]
        public CanRenameCollectionFileToResult(bool @canRename, string? @reasonWhyNot)
        {
            this.CanRename = @canRename;
            this.ReasonWhyNot = @reasonWhyNot;
        }

        [System.Text.Json.Serialization.JsonPropertyName("canRename")]
        public bool CanRename { get; }

        [System.Text.Json.Serialization.JsonPropertyName("reasonWhyNot")]
        public string? ReasonWhyNot { get; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class IntegrityReportCollectionResult
    {
        [System.Text.Json.Serialization.JsonConstructor]
        public IntegrityReportCollectionResult(System.Guid @collectionId, string @collectionName, int @expectedTotalFileCount, bool @isCompleted, int @processedFileCount, System.Collections.Generic.IReadOnlyCollection<string> @reportFiles)
        {
            this.CollectionId = @collectionId;
        ...
        [System.Text.Json.Serialization.JsonPropertyName("expectedTotalFileCount")]
        ...
        [System.Text.Json.Serialization.JsonPropertyName("reportFiles")]
        public System.Collections.Generic.IReadOnlyCollection<string> ReportFiles { get; }
    ...
    public partial class IntegrityReportResult
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("startedOn")]
        public System.DateTimeOffset StartedOn { get; }
    ...
    {
        [System.Text.Json.Serialization.JsonConstructor]
        public SourceFolderInfo(System.Guid @collectionId, System.Guid @id, bool @isWebhookUploadEnabled, string @path, bool @shouldAddTagFromFilename, bool @shouldCheckFormat, bool @shouldCheckHashFromName, bool @shouldCreateTagsFromSubfolders, System.Collections.Generic.IReadOnlyCollection<string> @supportedExtensions, string? @webhookUploadUrl)
        {
            this.Id = @id;
            this.CollectionId = @collectionId;
            this.Path = @path;
    ...
    {
        [System.Text.Json.Serialization.JsonConstructor]
        public UpdateSourceFolderCommand(System.Guid @collectionId, bool @isWebhookUploadEnabled, string @path, bool @shouldAddTagFromFilename, bool @shouldCheckFormat, bool @shouldCheckHashFromName, bool @shouldCreateTagsFromSubfolders, System.Guid @sourceFolderId, System.Collections.Generic.IReadOnlyCollection<string> @supportedExtensions, string? @webhookUploadUrl)
        {
            this.CollectionId = @collectionId;
