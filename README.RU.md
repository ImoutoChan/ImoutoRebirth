...
7. Опционально, можно установить расширение для Chrome, которое будет подсвечивать сохраненные или связанные с сохраненными картинки на бурах. [Ссылка на расширение](https://chrome.google.com/webstore/detail/imouto-extension/ieilellpakdngfomipoedkgfaeddfffc)
